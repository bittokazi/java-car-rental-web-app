	...
	<table class='tb'>
		...
		<c:forEach items="${drivelist}" var="drive">
			<tr>
			    ...
			    <td class='tb'>${drive.to_place} <button onclick="view_map('${drive.from_place}, dhaka', '${drive.to_place}, dhaka');">View on Map</button></td>
			    ...
			    <c:choose>
				    	<c:when test="${sessionScope.role=='driver'}">
				        	<td class='tb'><a href="profile?un=${drive.rider_username}">Go</a></td>
				    	</c:when>
				    	<c:otherwise>
				        	<td class='tb'><a href="profile?un=${drive.driver_username}">Go</a></td>
				    	</c:otherwise>
				</c:choose>
				<c:choose>
				    	<c:when test="${sessionScope.role=='driver'}">
				        	<td class='tb'><a href="schedule?action=done&id=${drive.id}">Done</a></td>
				    	</c:when>
				    	<c:otherwise>
